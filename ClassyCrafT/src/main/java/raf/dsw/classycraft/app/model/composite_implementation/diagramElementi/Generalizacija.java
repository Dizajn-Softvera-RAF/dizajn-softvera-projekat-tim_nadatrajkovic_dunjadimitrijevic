...
public class Generalizacija extends Connection {
    ...
    @JsonCreator
    public Generalizacija(@JsonProperty("type") String type, @JsonProperty("name") String name, @JsonProperty("odTacka") Point odTacka, @JsonProperty("doTacka") Point doTacka,
